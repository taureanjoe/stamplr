          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden md:flex justify-center relative">
              <div className="relative w-full max-w-md">
                <div className="aspect-square rounded-2xl glass-card p-4 flex items-center justify-center shadow-glow overflow-hidden">
                  <Image
                    src="/hero-stamp.png"
                    alt="Digital stamp on engineering blueprint"
                    width={400}
                    height={400}
